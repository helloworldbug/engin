// 文件名称: Scratch_setAttr
//
// 创 建 人: fishYu
// 创建日期: 2015/11/30 11:25
// 描    述: Scratch_setAttr
dms.Scratch.createObject = function(item, scriptParser){
    var displayObject = new dms.Scratch();
    //displayObject.userData = item;
    //ROSetItemId.call(displayObject,item, scriptParser);
    this._scratchPopupView = null;
    return displayObject;
};

dms.Scratch.prototype.resetAttribute = function(){
...
//            style.lineHeight = font_size;
        ...
        //假话
        if(!this._scratchPopupView){
            this._scratchPopupView = new dms.ClipPopupView(this.parent.element,item, this);
        }
