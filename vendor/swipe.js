...
function Swipe(container, options) {
  ...
  function setup() {
    ...
    //TODO 此处处理是为了让图集的宽度正确。   由于container.getBoundingClientRect().width  和 container.offsetWidth差距较大
    width = container.offsetWidth;
    //modify by fishYu 2016-9-20 18:37修改图集隐藏的情况下获取不到宽度
    if (width == 0) {
