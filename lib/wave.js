...
//
// 创 建 人: chenshy
// 创建日期: 2015/10/15 14:07
// 描    述: wave.js
(function(){

    var tpl =
        '<div class="loading-wave-me-container">' +
//        '<div class="loading-wave-size loading-wave3"></div>' +
//        '<div class="loading-wave-size loading-wave2"></div>' +
        '<div class="loading-wave-size loading-wave">' +

        '</div>' +
        "<div class='loading-wave-percent' style='position:absolute;margin: 0 auto;width:88px;height:96px;line-height:96px;text-align: " +
        "center;font-size:26px;color: #333333;opacity: 0'>0%</div></div>" +
        '<div class="loading-wave-melogo loading-wave-size" style="width:87px;"></div>';
